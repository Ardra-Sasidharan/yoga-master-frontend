      ...
      <div className="min-h-screen flex justify-start pl-11 text-white items-center bg-black bg-opacity-60">
        <div className="">
          <div className="space-y-4">
            <h3 className="md:text-4xl text-2xl">We Deliver</h3>
            <h1 className="md:text-7xl text-4xl font-bold ">
              Premium Yoga Sessions
            </h1>
            <div className="md:w-1/2">
              <p className="">
                Join us today to experience the transformative power of yoga and
                find balance, strength, and peace in your life!
              </p>
            </div>
